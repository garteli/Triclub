    ...
    <div style={s('padding:6px 0 120px;animation:floatUp .35s ease')}>
      ...
      <div style={s('margin:14px 18px 0;display:flex;gap:10px')}>
        ...
        <div style={s('flex:1;background:var(--bg2);border:1px solid var(--line);border-radius:16px;padding:13px 14px')}>
          <div style={s('font-size:10px;color:var(--text3);text-transform:uppercase;letter-spacing:.8px;font-weight:600')}>👑 Domestique Team QOM</div>
      ...
      {/* squad leaderboard */}
      <div style={s(label + ';margin:22px 18px 12px')}>Domestique Team leaderboard</div>
