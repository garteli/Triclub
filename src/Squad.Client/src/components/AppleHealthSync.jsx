      ...
      <div style={s('background:var(--bg2);border:1px solid var(--line);border-radius:16px;padding:15px 15px 16px')}>
        ...
        {!available ? (
          <div style={s('font-size:11.5px;color:var(--text3);margin-top:12px;line-height:1.5')}>
            Apple Health lives on your iPhone, so this works in the <b>Domestique Club iOS app</b> — not the web version. Install the app and open this screen there to sync.
          </div>
        ) : (
          <>
            {/* range selector */}
