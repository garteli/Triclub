...
// time to the top. Renders nothing when there's no climb nearby or the user dismissed this one.
...
export default function ClimbPro({ climb }) {
  ...
  const border = climbing ? 'color-mix(in srgb,var(--accent) 22%,transparent)' : 'var(--line)';
  const glow = climbing ? ';box-shadow:0 0 0 1px color-mix(in srgb,var(--accent) 10%,transparent)' : '';
